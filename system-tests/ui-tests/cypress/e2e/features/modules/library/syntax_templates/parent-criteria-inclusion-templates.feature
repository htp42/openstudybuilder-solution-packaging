...
Feature: Library - Syntax Templates - Criteria - Inclusion - Parent
  ...
  Scenario: [Create][Sequence number] System must generate sequence number for Inclusion Criteria Templates when they are created
    ...
    And [API] 'Inclusion' Criteria in status Draft exists
    And The criteria is found
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Inclusion Criteria template without: Indication or Disorder
    Given The 'library/criteria_templates/Inclusion/parent' page is opened
    And The Add template button is clicked
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Inclusion Criteria template without: Criterion Category
    Given The 'library/criteria_templates/Inclusion/parent' page is opened
    And The Add template button is clicked
    And The criteria template form is filled with base data
    And Form continue button is clicked
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Inclusion Criteria template without: Criterion Sub-Category
    Given The 'library/criteria_templates/Inclusion/parent' page is opened
    And The Add template button is clicked
    And The criteria template form is filled with base data
    And Form continue button is clicked
  ...
  Scenario: [Cancel][Creation] User must be able to Cancel creation of the Inclusion Criteria template
    Given The 'library/criteria_templates/Inclusion/parent' page is opened
    And The Add template button is clicked
  ...
  Scenario: [Cancel][Edition] User must be able to Cancel edition of the Inclusion Criteria template
    Given [API] 'Inclusion' Criteria in status Draft exists
    And The 'library/criteria_templates/Inclusion/parent' page is opened
    And User intercept getCriteria request
    And User awaits for the getCriteria request to finish
  ...
  Scenario: [Cancel][Indexing edtion] User must be able to Cancel indexes edition of the Inclusion Criteria template
    Given [API] 'Inclusion' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Inclusion/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Edit][1.1 version] User must be able to edit new version of the Inclusion Criteria template
    Given [API] 'Inclusion' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Inclusion/parent' page is opened
    And User intercept getCriteria request
