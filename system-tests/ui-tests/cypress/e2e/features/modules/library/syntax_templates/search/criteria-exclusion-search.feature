...
Feature: Library - Syntax Templates - Exclusion Criteria - Search
    ...
    Scenario: [Test data] Data for search tests is created
        Given [API] Search Test - Create first 'Exclusion' criteria template
    ...
    Scenario: [Table][Search][Negative case] User must be able to search not existing Exclusion Criteria and table will correctly filtered
        Given The 'library/criteria_templates/Exclusion/parent' page is opened
