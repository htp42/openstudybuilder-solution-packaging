...
Feature: Library - Syntax Templates - Dosing Criteria - Search
    ...
    Scenario: [Test data] Data for search tests is created
        Given [API] Search Test - Create first 'Dosing' criteria template
    ...
    Scenario: [Table][Search][Negative case] User must be able to search not existing Dosing Criteria and table will correctly filtered
        Given The 'library/criteria_templates/Dosing/parent' page is opened
