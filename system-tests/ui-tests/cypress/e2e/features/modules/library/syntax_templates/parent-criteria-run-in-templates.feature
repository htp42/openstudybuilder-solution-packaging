@REQ_ID:1070684
Feature: Library - Syntax Templates - Criteria - Run-in - Parent

  As a user, I want to manage every Run-in Criteria template under the Syntax template Library
  Background: User must be logged in
    Given The user is logged in

  Scenario: [Create][Sequence number] System must generate sequence number for Run-in Criteria Templates when they are created
    Given [API] 'Run-in' Criteria in status Draft exists
    And The 'library/criteria_templates/Run-in/parent' page is opened
    ...
    And [API] 'Run-in' Criteria in status Draft exists
    And The criteria is found
    Then Sequence number is incremented

  @smoke_test
  Scenario: [Create][Positive case] User must be able to create Run-in Criteria template
  ...
  Scenario: [Create][N/A indexes] User must be able to create Run-in Criteria template with NA indexes
    Given The 'library/criteria_templates/Run-in/parent' page is opened
    And The Add template button is clicked
    When The criteria template form is filled with base data
    And Form continue button is clicked
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Run-in Criteria template without: Template Text
    Given The 'library/criteria_templates/Run-in/parent' page is opened
    And The Add template button is clicked
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Run-in Criteria template without: Indication or Disorder
    Given The 'library/criteria_templates/Run-in/parent' page is opened
    And The Add template button is clicked
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Run-in Criteria template without: Criterion Category
    Given The 'library/criteria_templates/Run-in/parent' page is opened
    And The Add template button is clicked
    And The criteria template form is filled with base data
    And Form continue button is clicked
  ...
  Scenario: [Create][Mandatory fields] User must not be able to create Run-in Criteria template without: Criterion Sub-Category
    Given The 'library/criteria_templates/Run-in/parent' page is opened
    And The Add template button is clicked
    And The criteria template form is filled with base data
    And Form continue button is clicked
  ...
  Scenario: [Create][Syntax validation] User must be able to verify syntax when creating Run-in Criteria template
    Given The 'library/criteria_templates/Run-in/parent' page is opened
    And The Add template button is clicked
  ...
  Scenario: [Create][Hide parameters] User must be able to hide parameter of the Run-in Criteria template
    Given The 'library/criteria_templates/Run-in/parent' page is opened
    And The Add template button is clicked
    When The new template name is prepared with a parameters
    And Form continue button is clicked
  ...
  Scenario: [Create][Select parameter] User must be able to select parameter of the Run-in Criteria template
    Given The 'library/criteria_templates/Run-in/parent' page is opened
    And The Add template button is clicked
    When The new template name is prepared with a parameters
    And Form continue button is clicked
  ...
  Scenario: [Cancel][Creation] User must be able to Cancel creation of the Run-in Criteria template
    Given The 'library/criteria_templates/Run-in/parent' page is opened
    And The Add template button is clicked
  ...
  Scenario: [Cancel][Edition] User must be able to Cancel edition of the Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
    And User awaits for the getCriteria request to finish
  ...
  Scenario: [Cancel][Indexing edtion] User must be able to Cancel indexes edition of the Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Edit][0.1 version] User must be able to edit initial version of the Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
    And User awaits for the getCriteria request to finish
  ...
  Scenario: [Actions][Delete]User must be able to delete the Draft Run-in Criteria template in version below 1.0
    Given [API] 'Run-in' Criteria in status Draft exists
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
    And User awaits for the getCriteria request to finish
  ...
  Scenario: [Actions][Approve] User must be able to approve the Draft Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
    And User awaits for the getCriteria request to finish
  ...
  Scenario: [Actions][Edit indexing] User must be able to edit indexing of Final Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Edit][Mandatory fields] User must not be able to save changes to Run-in Criteria template without: Change description
    Given [API] 'Run-in' Criteria in status Draft exists
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
    And User awaits for the getCriteria request to finish
  ...
  Scenario: [Actions][New version] User must be able to add a new version of the Final Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Edit][1.1 version] User must be able to edit new version of the Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Inactivate] User must be able to inactivate the Final Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And [API] Criteria is approved
    And The 'library/criteria_templates/Run-in/parent' page is opened
    And User intercept getCriteria request
  ...
  Scenario: [Actions][Reactivate] User must be able to reactivate the Retired Run-in Criteria template
    Given [API] 'Run-in' Criteria in status Draft exists
    And [API] Criteria is approved
    And [API] Criteria is inactivated
    And The 'library/criteria_templates/Run-in/parent' page is opened
