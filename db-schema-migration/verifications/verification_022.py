...
from tests import test_migration_022
...
def test_ct_config_values():
    test_migration_022.test_ct_config_values(migration)


def test_indexes_and_constraints():
    test_migration_022.test_indexes_and_constraints(migration)


def test_migrate_featureflag_nodes():
    test_migration_022.test_migrate_featureflag_nodes(migration)


def test_migrate_instance_split():
    test_migration_022.test_migrate_instance_split(migration)
